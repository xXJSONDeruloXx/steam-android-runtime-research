...
UI consumption and navigation are still unproven. The next experiment should
use a semantic navigation action such as D-pad list movement and retain the
same selector-region comparison.
