...
itself. See [doc 299](../00-start-here/299-nova-standalone-runtime-acquisition-product-requirement-2026-08-10.md).
...
[198](../20-termux-x11/198-termux-x11-198x-game-launch-result-2026-08-09.md).

The exact Nova lifecycle contract in [34](../00-start-here/34-nova-runtime-harness-lifecycle.md)
