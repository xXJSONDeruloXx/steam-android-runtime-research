...
the earlier UI-driven launch result in [198](../20-termux-x11/198-termux-x11-198x-game-launch-result-2026-08-09.md)
...
Before launch and on exit, the run follows [34](../00-start-here/34-nova-runtime-harness-lifecycle.md)
