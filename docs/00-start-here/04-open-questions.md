...
- Replace Termux:X11 output with the persistent AHardwareBuffer pool; the Nova lab now
  ...
  two-buffer baseline labeled in [doc 12](../10-ahb-and-harness/12-nova-gamescope-ahb-output.md).
...
- Partially answered: can the headless Gamescope seam sustain display-size Android
  ...
  ANGLE/softpipe rather than hardware rendering. See [doc 15](../10-ahb-and-harness/15-nova-steam-ui-ahb-smoke.md).
- What input protocol is least invasive: Android HID injection, Wayland input, SDL, or a custom socket?
  ...
  Android dispatch, SDL, and Steam-consumer seams; see [docs 16](../10-ahb-and-harness/16-nova-libei-input-smoke.md),
  [18](../10-ahb-and-harness/18-nova-uinput-gamepad-smoke.md), [20](../10-ahb-and-harness/20-nova-physical-controller-dispatch.md),
  [27](../10-ahb-and-harness/27-nova-sdl3-gamepad-event.md), and [29](../10-ahb-and-harness/29-nova-android-input-steam-ui-navigation.md).
...
- Can Android touch drive the live Gamescope session, and can Steam remain visible in
  ...
  the strict Steam-surface gate; see [doc 31](../10-ahb-and-harness/31-nova-android-touch-libei-fullscreen.md).
- Are frames reaching the Android panel in monotonically increasing order at a
  ...
  in [doc 12](../10-ahb-and-harness/12-nova-gamescope-ahb-output.md), correlate producer submit,
...
- Can the Nova expose hardware GLX/CEF for Steam? The bounded `msm` probe keeps
  ...
  initialization. See [doc 17](../10-ahb-and-harness/17-nova-steam-hardware-glx-probe.md).
- Why do some Steam OOBE language and network labels render as empty square or
  ...
  [doc 33](../10-ahb-and-harness/33-nova-steam-font-coverage-open-question.md); first capture
