...
- [docs/297](../40-productization/297-nova-gamenative-proton-arm64ec-result-2026-08-10.md) closed
  the incorrectly modeled attempt to run the Android/Bionic WCP inside the
  glibc Holo rootfs.
- [docs/299](../40-productization/299-nova-gamenative-bionic-direct-namespace-result-2026-08-10.md)
  ...
  namespace rules.
- [docs/300](../40-productization/300-gamenative-bionic-android-namespace-adapter-predeclaration-2026-08-10.md)
  predeclared the root-side namespace adapter.
- [docs/301](../40-productization/301-nova-gamenative-bionic-android-namespace-adapter-result-2026-08-10.md)
...
[`docs/40-productization/293-nova-android-wsi-layer-dmabuf-result-2026-08-10.md`](../40-productization/293-nova-android-wsi-layer-dmabuf-result-2026-08-10.md).
...
- Before every Nova device run, use the lifecycle contract in
  [`docs/00-start-here/34-nova-runtime-harness-lifecycle.md`](34-nova-runtime-harness-lifecycle.md).
