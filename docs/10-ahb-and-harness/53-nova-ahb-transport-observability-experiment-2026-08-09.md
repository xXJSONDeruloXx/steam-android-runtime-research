...
[`docs/10-ahb-and-harness/52-nova-ahb-app-receive-wait-result-2026-08-09.md`](52-nova-ahb-app-receive-wait-result-2026-08-09.md)
...
Before launch, reread `docs/00-start-here/34-nova-runtime-harness-lifecycle.md`, use a new
