...
- Compared with: `docs/00-start-here/34-nova-runtime-harness-lifecycle.md`,
  `docs/10-ahb-and-harness/35-parent-session-process-audit-2026-08-08.md`,
  `docs/10-ahb-and-harness/40-parent-session-process-audit-followup-2026-08-08.md`,
  `docs/10-ahb-and-harness/43-parent-session-process-audit-followup-2026-08-08.md`,
  `docs/10-ahb-and-harness/46-parent-session-process-audit-followup-2026-08-08.md`, and
  `docs/10-ahb-and-harness/50-parent-session-process-audit-followup-2026-08-08.md`.
