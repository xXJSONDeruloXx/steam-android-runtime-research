...
[`docs/10-ahb-and-harness/45-nova-ahb-seqpacket-result-2026-08-08.md`](45-nova-ahb-seqpacket-result-2026-08-08.md).
...
the lifecycle gate in `docs/00-start-here/34-nova-runtime-harness-lifecycle.md`. Send one A
