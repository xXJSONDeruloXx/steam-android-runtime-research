...
This run follows [34](../00-start-here/34-nova-runtime-harness-lifecycle.md) and the known-good
software-GL display control in [219](../30-runtime-and-games/219-nova-termux-x11-hardware-display-software-gl-isolation-experiment-2026-08-10.md).
