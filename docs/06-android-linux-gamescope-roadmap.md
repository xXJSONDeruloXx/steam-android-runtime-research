...
headless experiment now accepts a real Wayland surface and completes Vulkan compositor frames without that
identity; the remaining work is wiring its presentation to the persistent output pool.
