...
- [Nova Android AHardwareBuffer probe](docs/09-nova-android-ahardwarebuffer-handle-probe.md) records the NDK handle round-trip on the app side and its remaining Linux-to-Android gap.
