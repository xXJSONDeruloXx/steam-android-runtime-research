...
- [Nova Android AHardwareBuffer probe](docs/09-nova-android-ahardwarebuffer-handle-probe.md) records Android Vulkan import plus a bidirectional Android-to-Holo DMA-BUF/GPU handoff; visible presentation remains next.
