...
NOVA_EIS_TOUCH_BRIDGE="${NOVA_EIS_TOUCH_BRIDGE:-0}"
...
VULKAN_AHB_HEIGHT='$VULKAN_AHB_HEIGHT'
VULKAN_AHB_OUTPUT_SOCKET='$VULKAN_AHB_OUTPUT_SOCKET'
NOVA_AHB_OUTPUT_TILING='$NOVA_AHB_OUTPUT_TILING'
NOVA_AHB_VULKAN_READBACK='$NOVA_AHB_VULKAN_READBACK'
NOVA_AHB_VULKAN_READBACK_FRAME='$NOVA_AHB_VULKAN_READBACK_FRAME'
...
NOVA_STEAM_CLIENT_FLAGS='$NOVA_STEAM_CLIENT_FLAGS'
NOVA_HOLO_NAMESERVER='$NOVA_HOLO_NAMESERVER'
NOVA_EIS_TOUCH_BRIDGE='$NOVA_EIS_TOUCH_BRIDGE'
...
echo "\$NOVA_EIS_TOUCH_BRIDGE" >"\$ROOT/opt/nova-steam/eis-touch-bridge"
...
echo "\$NOVA_AHB_OUTPUT_TILING" >"\$ROOT/opt/nova-steam/ahb-output-tiling"
echo "\$NOVA_AHB_VULKAN_READBACK" >"\$ROOT/opt/nova-steam/ahb-vulkan-readback"
echo "\$NOVA_AHB_VULKAN_READBACK_FRAME" >"\$ROOT/opt/nova-steam/ahb-vulkan-readback-frame"
echo "rootfs.steam_client_timeout=\$NOVA_STEAM_CLIENT_TIMEOUT"
echo "rootfs.gamescope_timeout=\$NOVA_STEAM_GAMESCOPE_TIMEOUT"
echo "rootfs.ahb_output_tiling=\$NOVA_AHB_OUTPUT_TILING"
echo "rootfs.ahb_vulkan_readback=\$NOVA_AHB_VULKAN_READBACK"
echo "rootfs.ahb_vulkan_readback_frame=\$NOVA_AHB_VULKAN_READBACK_FRAME"
