...
OUTPUT=${NOVA_LIBEI_INPUT_BRIDGE_OUTPUT:-$BUILD_DIR/nova-libei-input-bridge}
...
mkdir -p "$SYSROOT"
if [ ! -f "$SYSROOT/usr/include/libei-1.0/libei.h" ]; then
...
cc \
    ...
    /src/device/nova-libei-input-bridge.c \
    -lei \
