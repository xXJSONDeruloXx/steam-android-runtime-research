...
SYSROOT="$BUILD_DIR/x11-animate-sysroot"
OUTPUT=${NOVA_X11_ANIMATE_OUTPUT:-$BUILD_DIR/nova-x11-animate}
...
SYSROOT=/out/x11-animate-sysroot
mkdir -p "$SYSROOT"
