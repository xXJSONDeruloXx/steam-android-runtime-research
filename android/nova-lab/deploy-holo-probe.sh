...
NOVA_EIS_TOUCH_DEVICE_HELPER=${NOVA_EIS_TOUCH_DEVICE_HELPER:-/opt/nova-kgsl-driver/nova-libei-input-bridge}
...
MOUNT_PRIVATE_HELPER=${NOVA_HOLO_MOUNT_PRIVATE_HELPER:-$BUILD_DIR/nova-mount-private}
