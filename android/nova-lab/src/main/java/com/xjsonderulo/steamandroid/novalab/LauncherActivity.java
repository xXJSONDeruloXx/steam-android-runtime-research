...
public final class LauncherActivity extends Activity {
    ...
    private static final String[] REQUIRED_ASSETS = {
            ...
            "nova-runtime4-bwrap-proxy-client.py",
            "nova-runtime4-bwrap-proxy",
            "nova-bsdtar-bootstrap/usr/bin/bsdtar",
            "nova-bsdtar-bootstrap/usr/bin/env",
            "nova-bsdtar-bootstrap/lib/ld-linux-aarch64.so.1",
            "nova-bsdtar-bootstrap/usr/lib/libacl.so.1",
            "nova-bsdtar-bootstrap/usr/lib/libarchive.so.13",
            "nova-bsdtar-bootstrap/usr/lib/libbz2.so.1.0",
            "nova-bsdtar-bootstrap/usr/lib/libc.so.6",
            "nova-bsdtar-bootstrap/usr/lib/libcrypto.so.3",
            "nova-bsdtar-bootstrap/usr/lib/libgcc_s.so.1",
            "nova-bsdtar-bootstrap/usr/lib/libicuuc.so.78",
            "nova-bsdtar-bootstrap/usr/lib/libicudata.so.78",
            "nova-bsdtar-bootstrap/usr/lib/liblz4.so.1",
            "nova-bsdtar-bootstrap/usr/lib/liblzma.so.5",
            "nova-bsdtar-bootstrap/usr/lib/libm.so.6",
            "nova-bsdtar-bootstrap/usr/lib/libstdc++.so.6",
            "nova-bsdtar-bootstrap/usr/lib/libxml2.so.16",
            "nova-bsdtar-bootstrap/usr/lib/libz.so.1",
            "nova-bsdtar-bootstrap/usr/lib/libzstd.so.1",
